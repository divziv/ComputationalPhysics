...
int main()
{
    ...
    double exact = cos(x);
    cout << "The value of cos(" << x << ") is: " << exact << "\n\n";
    ...
    {
        h/=pow(2,i);
        calculate=(sin(x+h)-sin(x))/h;
        cout << "The value of sin(" << x << ") at (h=" << h << ") is: " << calculate << "\n";
    ...
    {
        h/=pow(2,i);
        calculate=((4*sin(x+h))-(3*sin(x))-(sin(x+2*h)))/(2*h);
        cout << "The value of sin(" << x << ") at (h=" << h << ") is: " << calculate << "\n";
    ...
    {
        h/=pow(2,i);
        calculate=((sin(x))-(4*sin(x-h))+(sin(x-2*h)))/(2*h);
        cout << "The value of sin(" << x << ") at (h=" << h << ") is: " << calculate << "\n";
    ...
    {
        h/=pow(2,i);
        calculate=((8*sin(x+h))-(sin(x+2*h))-(8*sin(x-h))+(sin(x-2*h)))/(12*h);
        cout << "The value of sin(" << x << ") at (h=" << h << ") is: " << calculate << "\n";
