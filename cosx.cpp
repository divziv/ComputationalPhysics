...
int main()
{
    ...
    double exact = sin(x);
    exact*=(-1);
    cout << "The value of -sin(" << x << ") is: " << exact << "\n\n";
    ...
    {
        h/=pow(2,i);
        calculate=(cos(x+h)-cos(x))/h;
        cout << "The value of cos(" << x << ") at (h=" << h << ") is: " << calculate << "\n";
    ...
    {
        h/=pow(2,i);
        calculate=((4*cos(x+h))-(3*cos(x))-(cos(x+2*h)))/(2*h);
        cout << "The value of cos(" << x << ") at (h=" << h << ") is: " << calculate << "\n";
    ...
    {
        h/=pow(2,i);
        calculate=((cos(x))-(4*cos(x-h))+(cos(x-2*h)))/(2*h);
        cout << "The value of cos(" << x << ") at (h=" << h << ") is: " << calculate << "\n";
    ...
    {
        h/=pow(2,i);
        calculate=((8*cos(x+h))-(cos(x+2*h))-(8*cos(x-h))+(cos(x-2*h)))/(12*h);
        cout << "The value of cos(" << x << ") at (h=" << h << ") is: " << calculate << "\n";
